...
(i.e. 9600), <COMx:> with your COM port (i.e. COM4: or /dev/ttyS1) and
<value> with the value to write.

For example, to read the first holding register (40001) from slave id #1 on
COM3: you can use the following:
modpoll -m rtu -a 1 -t 4 -r 1 -b 9600 COM3:

To write the value 100 to the above register, use the following:
modpoll -m rtu -a 1 -t 4 -r 1 -b 9600 COM3: 100
